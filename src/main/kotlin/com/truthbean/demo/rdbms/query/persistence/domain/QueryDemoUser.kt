package com.truthbean.demo.rdbms.query.persistence.domain
...
data class QueryDemoUser(
    ...
    override fun toString(): String {
        return "QueryDemoUser{userUUID='$userUUID\', userName='$userName\', userRealName='$userRealName\', userPassword='$userPassword\', userEmail='$userEmail\', userPhone='$userPhone\'}"
    }
}